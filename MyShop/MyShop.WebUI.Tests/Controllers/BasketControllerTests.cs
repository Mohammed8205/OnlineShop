...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "jahirtech17@gmail.com", ZipCode = "22140" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("jahirtech17@gmail.com", "Forms"), null);
